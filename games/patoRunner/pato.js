...
function JuegatonUpdate(){
    if(disntancia >= 100 && juegatonScore == 0) { juegatonScore+=10; }
    if(disntancia >= 200 && juegatonScore == 10) { juegatonScore+=10; }
    if(disntancia >= 300 && juegatonScore == 20) { juegatonScore+=10; }
    if(disntancia >= 400 && juegatonScore == 30) { juegatonScore+=10; }
    if(disntancia >= 500 && juegatonScore == 40) { juegatonScore+=10; }
    if(disntancia >= 600 && juegatonScore == 50) { juegatonScore+=10; }
    if(disntancia >= 700 && juegatonScore == 60) { juegatonScore+=10; }
    if(disntancia >= 800 && juegatonScore == 70) { juegatonScore+=10; }
    if(disntancia >= 900 && juegatonScore == 80) { juegatonScore+=10; }
    if(disntancia >= 1000 && juegatonScore == 90) { juegatonScore+=10; }
    
    if(juegatonScore > 100) {juegatonScore = 100}
    console.log(juegatonScore);

    document.getElementById("main-frame-error").style.display = "none";
    document.getElementById("main").style.display = "block";

    document.getElementById("scoreMain").textContent = juegatonScore;
}
